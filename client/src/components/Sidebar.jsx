          ...
          {navItems.map(({ to, label, Icon }) => {
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  `px-3.5 py-2.5 flex items-center gap-3 rounded ${isActive ? 'bg-gradient-to-r from-[#397df2] to-[#b260ff] text-white' : ''
                  }`
                }
              >
        ...
        <div onClick={openUserProfile} className='flex gap-2 items-center cursor-pointer'>
          ...
          <div >
            ...
            <p className='text-xs text-gray-500'>
              {user?.privateMetadata?.plan === 'premium' ? 'Premium' : 'Free'} plan
            </p>
