...
const Footer=()=> {
    return (
        <footer >
            <div className="flex flex-col  md:flex-row justify-between w-full border-b border-gray-500/30 pb-4">
                 <div className="md:max-w-100 md:ml-20  flex flex-col justify-start">
                    <img src={assets.logoAI} alt="" className='w-28 h-24 ml-25' />
                    <p className="mt-4 text-sm ml-10 p-2">
                 ...
                 <div className="px-4 sm:px-20 my-5 md:my-0 ">
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright  {new Date().getFullYear()}  © <Link to='/'>Aizen</Link>. All Right Reserved.
            </p>
        </footer>
    );
};
